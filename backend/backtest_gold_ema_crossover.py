#!/usr/bin/env python3
"""
backtest_gold_ema_crossover.py — Backtest for TradingView Gold (XAUUSD / MCX GOLD) EMA 9/15 Crossover Strategy.
...
def main():
    ...
    data_map = {
        "1m": Path(__file__).parent / "archive_commodities" / "GOLD_1minute.csv",
        "5m": Path(__file__).parent / "archive_commodities" / "GOLD_5minute.csv",
        "15m": Path(__file__).parent / "archive_commodities" / "GOLD_15minute.csv",
    }
