...
Mirrors backtest_currency.py's proven structure, pointed at NIFTY/BANKNIFTY
...
Differences from the currency path, both real and deliberate:
  ...
  - Cost model: strategy/index_futures_costs.py -- STT 0.05% on sell-side
...
Usage:
    python3 backtest_index_futures.py --symbols NIFTY
    python3 backtest_index_futures.py --symbols NIFTY BANKNIFTY
"""
...
from strategy.index_futures_costs import compute_index_futures_costs, size_index_futures_lots
