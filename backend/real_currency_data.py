...
Mirrors real_commodity_data.py exactly, for USDINR/EURINR/GBPINR/JPYINR
...
Usage:
    python3 -m real_currency_data                 # full initial backfill, all 4 pairs, all intervals
    python3 -m real_currency_data --topup           # incremental: only fetch days newer than what's archived
"""
...
if __name__ == "__main__":
    setup_logger("", log_file=str(Path(__file__).resolve().parent / "logs" / "real_currency_data.log"))
