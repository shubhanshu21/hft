#!/usr/bin/env python3
"""
markets/currency/experiments/ema_crossover.py — Backtest EMA 9/15 Crossover Strategy on Currency Derivatives.
...
from markets.currency.costs import compute_ncd_currency_costs, size_currency_lots, CURRENCY_SPECS
