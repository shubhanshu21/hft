"""
markets/index_futures/costs.py — Official NSE Index Futures (NIFTY/BANKNIFTY) Statutory Cost & Lot Sizing Model

Mirrors markets/currency/costs.py's shape exactly, but with the genuinely
...
def size_index_futures_lots(
    ...
    """Mirrors markets/currency/costs.py's size_currency_lots exactly."""
