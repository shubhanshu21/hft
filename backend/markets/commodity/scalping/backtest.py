...
from markets.commodity.costs import (
...
def run_commodity_backtest(
    ...
    # archived as CRUDEOIL_5minute.csv, matching markets/commodity/data.py's
    ...
    aliases = {
        ...
        "SILVERM": "SILVER",
        "COPPER": "COPPER",
        # Added 2026-09-18 (base metals survey) -- matches markets/commodity/data.py's
...
def main():
    ...
    parser.add_argument("--use-crude-regime-filter", action="store_true",
                         help="CRUDEOILM only: gate entries by a rolling 15-day daily-return-autocorrelation regime check (see core/regime.py docstring for the train/test result)")
